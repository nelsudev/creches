# Cooperativa de Habitação Económica "As Sete Bicas"
...
- [Cooperativa de Habitação Económica "As Sete Bicas" — Câmara Municipal de Matosinhos](https://www.cm-matosinhos.pt/servicos/acao-social-e-saude/areas-de-intervencao/infancia-e-juventude/instituicoes-sociais/creches/poi/cooperativa-de-habitacao-economica-as-sete-bicas) — consultado em 2026-07-30 — confirma morada, telefones, email e site.
- [Creche — C.H.E. "As Sete Bicas"](https://www.setebicas.com/atividades/) — consultado em 2026-07-30 — confirma creche 0–3, horário, cerca de 40 crianças e sala de berçário no processo de pré-inscrição.
- [Creche Cooperativa de Habitação Económica Sete Bicas — Carta Social](https://www.cartasocial.pt/resultados-da-pesquisa?_SocialLetterPortlet_WAR_cartasocialportlet__facesViewIdRender=%2Fviews%2FsocialLetter%2Flist%2Fview%2Fequipment%2Fequipment_detail.xhtml&_SocialLetterPortlet_WAR_cartasocialportlet_idEquipment=3683&p_p_col_count=1&p_p_col_id=column-1&p_p_id=SocialLetterPortlet_WAR_cartasocialportlet&p_p_lifecycle=0&p_p_mode=view&p_p_state=normal) — consultado em 2026-07-30 — confirma natureza jurídica, capacidade, ocupação registada e horário; dados da creche atualizados em 2025-01-20.
As pré-inscrições decorrem entre janeiro e abril para crianças já nascidas, segundo o site institucional. Confirmar diretamente a disponibilidade e os critérios de prioridade.
...
Ficha incompleta — abrir a página institucional para morada/contactos antes da fase de contacto telefónico.
