# Os Ramaldinhos - ASAS de Ramalde
...
- [Regulamento interno da Creche “Os Ramaldinhos”](https://asasderamalde.com/uploads/editor_uploads/files/Regulamento%20interno%20creche%20Ramaldinhos.pdf) — consultado em 2026-07-30 — confirma o acordo de cooperação e a admissão a partir dos 3 meses; documento institucional sem data de revisão recente visível.
- [Carta Social — Os Ramaldinhos (equipamento 29035)](https://www.cartasocial.pt/resultados-da-pesquisa?p_p_id=SocialLetterPortlet_WAR_cartasocialportlet&p_p_lifecycle=0&p_p_state=normal&p_p_mode=view&p_p_col_id=column-1&p_p_col_count=1&_SocialLetterPortlet_WAR_cartasocialportlet__facesViewIdRender=%2Fviews%2FsocialLetter%2Flist%2Fview%2Fequipment%2Fequipment_detail.xhtml&_SocialLetterPortlet_WAR_cartasocialportlet_idEquipment=29035) — consultado em 2026-07-30 — confirma entidade, morada, natureza solidária, capacidade e utentes; última atualização da resposta Creche em 2026-07-03, sem horário publicado.
- [Listagem de berçários em Ramalde — Primeira Imagem](https://www.primeiraimagem.com/bercarios-ramalde.php) — consultado em 2026-07-30 — confirma o nome "Os Ramaldinhos - ASAS de Ramalde" e a freguesia.
- [Entidades Rede Social Porto (jan. 2025), Câmara Municipal do Porto (PDF)](https://acaosocial.cm-porto.pt/files/uploads/cms/Entidades%20Rede%20Social%20Porto_jan_2025.pdf) — consultado em 2026-07-30 — item 76 "Associação de Solidariedade e Acção Social de Ramalde (ASAS de Ramalde)" confirma que a entidade está na rede social oficial do Porto (sem morada/contactos).
- [Mapeamento de Recursos Sociais do Município do Porto](https://acaosocial.cm-porto.pt/files/uploads/cms/Mapeamento_Recursos_Sociais_Municipio_Porto.pdf) — consultado em 2026-07-30 — confirma morada, contactos, capacidade e horário.
...
O mapeamento municipal indica 08:00–19:00, mas a ficha atual da Carta Social não publica horário. O horário fica por confirmar em contacto humano.
